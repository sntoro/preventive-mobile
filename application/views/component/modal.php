                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-body model-container">
                                                            ...
                                                            <p>This is Photoshop's version of Lorem IpThis is Photoshop's </p>
                                                            <div class="overflow-container">
                                                                <h5>Overflow container</h5>
                                                            </div>
                                                            <img src="<?php echo base_url('assets/files/images/modal/overflow.jpg') ?>" alt="" class="img img-fluid">
                                                            <p class="p-t-15">Similique velit aut et cumque illum consequatur doloribus quis ipsam sunt sint qui impedit nihil voluptate 
                                                                dicta delectus nostrum illum incidunt laboriosam est maxime eum debitis et explicabo quia doloribus quod occaecati tempore 
                                                                laudantium perspiciatis.</p>
                                                        </div>
                                                        <div class="p-15">
                                                            <h5 class="font-header">Some text above the scrollable box</h5>
                                                            <p>This is Photoshop's version of Lorem IpThis is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. 
