(function($){
	...
	var base_url = 'http://localhost/samara-mobile/';
	...
	$.audioRecorder = function(options){
		...
		var settings = $.extend({
			bufferLen:4096,
			workerSrc:{
				wav:base_url+'assets/js-audiorecorder-master/js/audiorecorder_worker_wav.js',
				mp3:base_url+'assets/js-audiorecorder-master/js/audiorecorder_worker_mp3.js'
			},
			getFileName:null,
			onaccept:function(){},
			onerror:function(){},
